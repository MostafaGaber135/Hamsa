  ...
  ar: {
    ...
    landing: {
      ...
      features: {
        ...
        privacy: { title: 'الخصوصية أولًا', body: 'لا يقرأ المحادثة إلا أعضاؤها. أخفِ حالة اتصالك، واحظر من تشاء، واحذف حسابك متى أردت.' },
        people: { title: 'أصدقاء ومجموعات', body: 'أضف أصدقاءك، وأنشئ مجموعات، واترك رسائل الغرباء في تبويب طلبات مستقل.' },
        bilingual: { title: 'العربية والإنجليزية', body: 'الواجهة كلها تنعكس للعربية، وكل رسالة تحتفظ باتجاهها.' },
        app: { title: 'ثبّته كتطبيق', body: 'أضف همسة إلى شاشتك الرئيسية: إشعارات، ومشاركة من معرض الصور، ويفتح دون اتصال.' },
      },
    },
  },
