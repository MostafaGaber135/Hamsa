...
export const en = {
  ...
  notifications: {
    ...
    empty: 'Nothing yet. Friend requests, reactions, mentions and replies show up here.',
    friendRequest: (name: string) => `${name} sent you a friend request`,
    friendAccepted: (name: string) => `${name} accepted your friend request`,
    addedToGroup: (name: string, group: string) => `${name} added you to ${group}`,
    addedToAGroup: (name: string) => `${name} added you to a group`,
    madeAdmin: (name: string, group: string) => `${name} made you an admin of ${group}`,
    madeAdminOfAGroup: (name: string) => `${name} made you a group admin`,
    reaction: (name: string, emoji: string) => `${name} reacted ${emoji} to your message`,
    reactedTo: (name: string) => `${name} reacted to your message`,
    mention: (name: string, group: string) => `${name} mentioned you in ${group}`,
    mentionAnywhere: (name: string) => `${name} mentioned you`,
    reply: (name: string) => `${name} replied to your message`,
    nowFriends: 'You’re friends now',
    unread: (count: string) => `${count} new`,
  },
  friends: {
    title: 'Friends',
    open: 'Friends',
  ...
  needsHttps:
    'The microphone, camera and notifications only work on a secure address. Open Hamsa from its https:// link.',
  tryAgain: 'Try again',
